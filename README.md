...
![Contribution Graph](https://github-readme-activity-graph.vercel.app/graph?username=apoorvjdeshmukh&theme=github-compact&hide_border=true&area=true&custom_title=2025-2026%20Contributions&color=40c463&point=216e39)

![Contribution Graph](https://ghchart.rshah.org/40c463/apoorvjdeshmukh)
---
...
| Metric | Result |
|---|---|
| AI Retrieval Accuracy (Arabic) | MRR 0.12 to 1.0 |
| Compliance Savings | $500K+ per client annually |
| Tracking Accuracy Improvement | 70% to 95% |
| Engineering Velocity Gain | 12 to 20+ story points per developer per sprint |
| RAG End-to-End Response | Under 1.2 seconds |
| Manifest Processing Time Reduction | 20% |

---

## 🧠 How I Work

I use **Claude Code** and **Cursor** daily. I prototype features end-to-end, resolve production bugs independently, and stay close enough to the technical work to have real conversations with engineering — not just translate between them and the business.

My workflow:
- Discovery and user research
- Technical specs and PRDs
- Hands-on prototyping with AI tools
- End-to-end release ownership
- Metrics instrumentation and iteration

---

## 🏗️ Featured Project: Hybrid RAG Architecture

Built a production-grade multilingual document intelligence system for a GCC fintech marketplace. Investment analysts went from spending 2-3 days manually reviewing pitch decks to getting grounded answers in under 2 seconds.

**Stack:** Gemini Pro + Tesseract + PyMuPDF + Arabic Reshaper + BiDi + paraphrase-multilingual-MiniLM-L12-v2 + Qdrant + BM25 + Reciprocal Rank Fusion + GPT-4o + FastAPI + AWS App Runner + Vite + AWS Amplify + MongoDB + Docker

**Key metrics:**
- MRR 0.12 to 1.0 on Arabic retrieval
- 42ms retrieval latency
- Under 1.2s end-to-end response
- 95% OCR accuracy (English) / 90%+ (Arabic)
- 80% chunk relevancy

👉 [View RAG Architecture Diagram](https://apoorvdeshmukh.notion.site/Apoorv-Deshmukh-Product-Portfolio-30519c575893805e8eb2c8fb5bcb75c5)
...
**Data Analyst / Product Manager @ Aaron E. Henry Health** (Aug 2018 - Jan 2021)
HIPAA-regulated federally qualified health center. SQL and Tableau analytics across 10,000+ patient population, medical billing operations, EHR integrations.
...
- Product Management: Building AI-Powered Products — IBM
...
**US-based. No visa sponsorship required. Open to Senior PM roles in AI, Platform, and B2B SaaS.**
